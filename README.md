...
Then you will get a **interrupt10-13_dp51.xls** file and some output figures. This is one expert demonstration generated by the Dynamic Programming method in the scenario of extreme weather-related events happen at time $10^{th}-13^{th}$ (totally 4 hours).
